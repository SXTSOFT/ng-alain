...
import { NaPageHeaderConfig } from '@delon/abc';
export function fnNaPageHeaderConfig(): NaPageHeaderConfig {
  return Object.assign(new NaPageHeaderConfig(), { homeI18n: 'home' });
}
  ...
  static forRoot(): ModuleWithProviders {
    return {
      ...
      providers: [
        ...
        { provide: NaPageHeaderConfig, useFactory: fnNaPageHeaderConfig },
